...
//*** This Class for Add New Member in The Team ***//
public class AddStudentMemberPage {
	// Scene dimensions
	...
	public AddStudentMemberPage(Team team) {
		...
		majorsChoiceBox = new ChoiceBoxStyler(majors, 327, 32, 350, 351);
		addStudentPane.getChildren().addAll(studentNameTextField, studentID, majorsChoiceBox);
	}
	...
	public void createButtons(Team team) {
		createAddAnotherMemberButton(team);
		createCreateButton(team);
		createCancelButton();
	}

	public void createAddAnotherMemberButton(Team team) {
		...
		button.setOnAction(e -> {
			if (studentNameTextField.getText().isEmpty()) {
				...
				competitionDetailsPageTeam = new CompetitionDetailsPageTeam(CompetitionDetailsPageTeam.getcomp());
	...
	public void createCreateButton(Team team) {
